...
CREATE TABLE `estacionamento` (
  ...
  `id_tipo_estacionamento` int(11) NOT NULL,
  PRIMARY KEY (`id_estacionamento`),
  KEY `id_quadra` (`id_quadra`),
  KEY `id_tipo_estacionamento` (`id_tipo_estacionamento`),
  CONSTRAINT `estacionamento_ibfk_1` FOREIGN KEY (`id_quadra`) REFERENCES `quadra` (`id_quadra`),
  CONSTRAINT `estacionamento_ibfk_2` FOREIGN KEY (`id_tipo_estacionamento`) REFERENCES `tipo_estacionamento` (`id_tipo_estacionamento`)
